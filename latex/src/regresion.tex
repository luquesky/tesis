...
En el modelo clásico de regresión lineal, tenemos un conjunto de valores fijos $X_1, X_2, \ldots, X_n$, que son llamados variables independientes. Asociado a cada uno de estos valores fijos, tenemos variables aleatorias $Y_1, \ldots, Y_n$. Asumimos, además, que nuestras variables son de la forma

\begin{equation}
  Y_i = E[Y|X_i] + u_i
\end{equation}

\noindent donde $u_i$ es la perturbación estocástica de la variable.
...
Nuestro objetivo es poder entonces conseguir estimadores $\widehat{\beta_1}, \widehat{\beta_2}$ que nos permitan analizar y predecir el comportamiento conjunto de estas variables. En la siguiente sección se describe el primer experimento, en el cual utilizamos el modelo ``pooled'' o agrupado, en el cual utilizamos todos los datos juntos indistintamente de la sesión y hablante del que provengan.
